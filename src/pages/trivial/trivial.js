...
function resetValues() {
  ...
  // document.getElementsByClassName('Math')[0].style.width = '0%'
  // document.getElementsByClassName('Language')[0].style.width = '0%'
  // document.getElementsByClassName('Science')[0].style.width = '0%'
  // document.getElementsByClassName('Socials')[0].style.width = '0%'
}
